...
import com.ecommerce.CategoryService.error.ApiError;
...
public class RestExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleException(CategoryAlreadyExistsException e, HttpServletRequest request){
